...
**Please click the video picture to see the short/condensed market update and price report** covering price only, or **[click HERE to see the longer video](https://youtu.be/JgbcaujjS64){: target="_blank" rel="noopener"}** where I dive deeper into the inventory levels, time on market, etc.&nbsp;
...
For more details either give me a call, send me an email, or simply [CLICK HERE](/contact/){: target="_blank" rel="noopener"} to complete a contact form and include a short message with some details.
