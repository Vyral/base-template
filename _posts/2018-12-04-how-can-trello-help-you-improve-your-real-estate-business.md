...
You can organize clients by lists, upload files and attachments, and manage the listing process from start to finish. You can import checklists and move projects and listings along the pipeline into different lists and boards.
