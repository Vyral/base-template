...
**In short, your other options don’t automatically mean using a hard money loan.** There are equity-based programs where we look at the income being produced by the property so it becomes a standalone entity. We look at your credit and the income being produced by the property to see whether you qualify for refinancing or cashing out. Right now, we’re going all the way up to 70% loan-to-value on these programs.&nbsp;
