...
tags:
  - Real Estate
excerpt: >-
  If you want to use open houses to attract more clients, there are a few key
  tips you need to remember.
enclosure: >-
  https://s3.amazonaws.com/vyralmarketing/Frank+Gray/Abby+Realty-+3+Tips+That+Will+Help+You+Use+Open+Houses+to+Get+More+Clients.mp4
pullquote: >-
  The real value comes from reinforcing the message to all the homeowners in
  that neighborhood that you’re the agent of choice—the neighborhood specialist.
...
How do you select a home for an open house that will attract a lot of potential clients and make you money? Here are the key tips you need to remember.

First, **pick a home that’s very accessible**, not tucked away in a cul-de-sac in the very back of the neighborhood.

Second, **choose a home that’s visible**. If you can get a home on a corner or one next to a major highway or thoroughfare, that’s all the better. If people can see the home and see that it’s easy to get to it, they’re more likely to come.
