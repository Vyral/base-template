---
layout: post
title: 'Radon: Things Every Homeowner Should Know'
date: 2018-11-13 21:53:30
tags:
  - Real Estate
excerpt: >-
  The detection and mitigation of radon is a crucial subject for homeowners, and
  today we’ve brought on an expert to explain not only how these processes are
  done, but also why they’re important.
enclosure: >-
  https://s3.amazonaws.com/vyralmarketing/Adam+Stary/2018/The+Stary+Group-+Radon.mp4
pullquote:
enclosure_type: video/mp4
enclosure_time:
use_youtube_image: true
youtube_alternate_image:
youtube_code: tCtT1GDmbO0
---

{% include youtube.html %}

The detection and mitigation of radon is a crucial subject for homeowners, and today we’ve brought on an expert to explain not only how these processes are done, but also why they’re important.
...
00:54 - Dave explains what radon gas actually is.

2:56 - Dave explains what an acceptable radon level is.

3:38 - Dave explains the mitigation process.

4:59 - Dave explains how he gets PVC pipe into the foundation when installing mitigation systems.
