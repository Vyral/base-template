...
tags:
  - Real Estate
excerpt: >-
  Accessory dwelling units can be a great addition to your property, but there
  are a few things you need to keep in mind before you start building.
enclosure: >-
  https://s3.amazonaws.com/vyralmarketing/Scott+Himelstein/2018/Porter+Ranch+Real+Estate-+ADU+-+Accessory+Dwelling+Unit.mp4
pullquote: 'Depending on what you’re trying to build, ADUs can be cost prohibitive.'
enclosure_type: video/mp4
enclosure_time:
use_youtube_image: true
youtube_alternate_image:
youtube_code: 7D8FQkb_0P4
---

{% include youtube.html %}

<p style="texct-algin: center;"><em>Accessory dwelling units can be a great addition to your property, but there are a few things you need to keep in mind before you start building.</em></p>
