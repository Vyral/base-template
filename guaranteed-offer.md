...
<h1 class="join-us">An Easier Way to Sell Your Athens Home</h1>
<h5 class="join-us-subtitle">Get a guaranteed offer within as little as 7 days on your home</h5>

<div class="whitespace">&nbsp;</div>

<div class="col-md-6">
<img class="post-image" style="margin-bottom: 20px;" src="/uploads/shutterstock-1361250668.jpg" width="5125" height="2883" />
...
<div class="col-md-6">
  ...
  <form method="post" class="home-value cta-forms" action="/thankyou" id="guaranteed-offer-form">
    <fieldset>
      ...
      <label for="address">Full Address* </label> <input type="text" required="" name="address" /> 
